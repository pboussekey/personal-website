...
@Component({
  ...
  animations : [
    trigger("buildingState", [
        state("firstPlan", style({ right : "calc(100% + 80rem)" })),
        state("secondPlan", style({ right : "calc(100% + 80rem)", transform : "scale(0.8)",  transformOrigin : 'bottom right', backgroundColor : '#004099' })),
